    ...
    return (
        <div className="projectPage">
            ...
            <p>
                ...
                direction would be in the inventory. If you didn&apos;t have a
                marker that let you move to the left, you would be unable to. We
                had three types of markers: basic movement,
                <Tooltip
                    text="wind"
            ...
            <p>
                ...
                with the Unity&apos;s animation system. Due to that, I spent a
                lot of time fine tuning animations and setting things up so that
                they worked properly. In order to make the animations look good,
                I had to completely refactor the movement portion of the
                character controller. In Unity, if an animation alters a
                gameobjets position, you cannot alter the position directly via
                a script. That caused some issues that resulted in a lot of
                wasted time. I was also juggling trying to teach the most
                inexperienced member of the team, and so had spent some time
                talking through design philosophies with them. Due to all the
                time spent struggling with the animation system, coaching,
                having design discussions about how to implement features, as
                well as the jam being 2 hours shorter than normal, the final
                game ended up with a lot of bugs. Overall, the jam was still a
                success and the team all learnt a lot and had fun!
            </p>
            <h2>Bugs</h2>
            <p>
            ...
            <p>
                The character isn&apos;t correctly tied to the tilemap. This has
                to do with using the animations to move the character. Since the
                ...
                fix this issue, I would make the character lerp it&apos;s
                position from one tile to the next while playing the animation,
                instead of using the animation to cause motion. This would
                ensure that the player is gridlocked while also providing a
                smooth visual. That would not solve the issue of the animation
                causing the sprite itself to shift, so to fix that, there are a
                few options. I would probably adjust the sprite renderer offset
                to fix the issue. Since the levels are small, the offset should
                never get too large. Of course fixing the art asset so that the
                final frame lines the character up to be in the same position as
                the initial frame would also fix the issue.
            </p>
            <p>
            ...
            <p>
                ...
                was originally, so it&apos;s a matter of cleaning up gameobjects
                and resetting variable values.
            </p>
            <h2>FInal thoughts</h2>
            <p>
                Despite the final product being a bug ridden mess, that&apos;s
                OK. Game jams are a place where failure is epected and
                encouraged. They are a place where people should feel
                comfortable showing a messy, incomplete, bug ridden project to
                others. What is important is if the creators had fun and learnt
                new things. In that sense, this jam was an absolute success. I
                certainly had a good time and I learnt a lot, both about how to
                teach others my knowledge, as well as simply improving my
                skills. Another important lesson that I learnt is that nothing
                is perfect. For example, my custom tilemap system was a bad fit
                for this game. It was difficult to force the correct features
                into it, though we did manage in the end. Overall, this jam was
                a great time and I am proud to say that I had a part in making
                this game!
            </p>
