    ...
    return (
        <div className="projectPage">
            ...
            <p>
                ...
                when cells adjacent to 0&apos;s automatically open). Driven by
                the urge to prove that setting up zero-spreading is not that
            ...
            <p>
                ...
                as for the text font that I&apos;m using. The entire project
                took me about 1 weekend.
            </p>
            ...
            <p>
                Unity tilemaps are designed in such a way that they can&apos;t
                easily store unique data by default. The solution that I found
                was creating a custom Cell script that inherited from the{" "}
                <Button
                    colorScheme="none"
                    buttonType="inline"
                ...
                each tile and, if it&apos;s not a mine, count the number of
                mines in the surrounding cells. Then, I assign that number to be
                the value that the cell represents.
            </p>
            <p>
                The second complication of laying the mines was easier to deal
                with. The reason it&apos;s an issue is because there are a few
                things that need to be dynamically checked. The first cell that
                the player opens cannot be a mine, and a cell also cannot
                contain two mines. I also decided that all the cells adjacent to
                the initial cell should not contain a mine. Ensuring that the
